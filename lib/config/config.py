...
NTESTEXPTS = 100 #Number of experiments to test the FB algorithm's Judge with
...
schedule_dict_train = {}
schedule_dict_train["OFF_TIME"] = 60    #Days that cores turn off for a long outage
schedule_dict_train["UP_TIME"] = 1035   #Day interval between long outages
schedule_dict_train["KILL_CORES"] = []#"Core_2"] #List the name of core(s) to shut down
schedule_dict_train["KILL_DAYS"] = []#700] #List the days where cores in KILL_CORES shuts down
schedule_dict_train["TOTAL_RUN"] = 1550  #Total length of experiment
schedule_dict_train["MAINTENANCE_TIME"] =10 
schedule_dict_train["MAINTENANCE_INTERVAL"] = 106 #Day interval between maintenance outages

schedule_dict_train["FIRST_KNOWNSHUTDOWNS"] = [1,549]
schedule_dict_train["FIRST_UNKNOWNSHUTDOWNS"] = []

#NOTE: These are not implemented for any use yet
schedule_dict_train["UNDECLARED_OUTAGE_CORE"] = "Core_1"
schedule_dict_train["UNDECLARED_OUTAGE_STARTS"] = [] #108]
schedule_dict_train["UNDECLARED_OUTAGE_LENGTHS"] = [30]
...
#NOTE: These are not implemented for any use yet
schedule_dict_test["UNDECLARED_OUTAGE_CORE"] = "Core_1"
schedule_dict_test["UNDECLARED_OUTAGE_STARTS"] = [] #108]
schedule_dict_test["UNDECLARED_OUTAGE_LENGTHS"] = [30]
...
schedule_dict_train["CORETYPES"] = cores
